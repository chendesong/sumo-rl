    ...
    with open(csv_path, "w", newline="", encoding="utf-8") as f:
        ...
        for method, r in results.items():
            w.writerow({
                ...
                "departed_total": r.get("departed_total"),
                "arrived_total": r.get("arrived_total"),
                "loaded_total": r.get("loaded_total"),
                "teleported_total": r.get("teleported_total"),
                "active_vehicle_count_end": r.get("active_vehicle_count_end"),
                "pending_vehicle_count_end": r.get("pending_vehicle_count_end"),
                "min_expected_number_end": r.get("min_expected_number_end"),
                "total_vehicle_demand": r.get("total_vehicle_demand"),
                "unfinished_vehicle_demand": r.get("unfinished_vehicle_demand"),
                "completion_rate_departed": r.get("completion_rate_departed"),
                "completion_rate_demand": r.get("completion_rate_demand"),
