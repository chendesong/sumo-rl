...
def train_ma2c(
    ...
    try:
        ...
        for ep in range(num_episodes):
            ...
            write_train_episode(artifact_dir, "ma2c", env, ep + 1, ep_R, seed=seed)
            write_green_split_episode(
                artifact_dir, "ma2c", env, ep + 1, stage="train", seed=seed
            )
        ...
        write_green_split_episode(
            artifact_dir, "ma2c", env, num_episodes + 1, stage="eval", seed=seed
        )
